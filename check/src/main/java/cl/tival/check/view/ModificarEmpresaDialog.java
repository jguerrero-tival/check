...
public class ModificarEmpresaDialog extends JDialog {
    ...
    public ModificarEmpresaDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//    	modificarButton.setEnabled(false);
    ...
    private void modificarButtonActionPerformed(ActionEvent evt) {
		if (!Rut.verificaRut(this.rutEmpresaTextField.getText())) {
			...
			int answer = empresaService.updateEmpresa(empresa);
