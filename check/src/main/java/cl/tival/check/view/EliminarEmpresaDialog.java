...
public class EliminarEmpresaDialog extends JDialog {
    ...
    public EliminarEmpresaDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    	rutEmpresaTextField.setEditable(false);
    	razonSocialEmpresaTextField.setEditable(false);
    	rutFacturaTextField.setEditable(false);
    	razonSocialFacturaTextField.setEditable(false);
    }
...
//		empresa.setRazonSocialRepresentante(this.razonSocialFacturaTextField.getText());
	...
	public void setEmpresa(Empresa empresa) {
    	...
    	rutEmpresaTextField.setText(this.empresa.getRut());
    	razonSocialEmpresaTextField.setText(this.empresa.getRazonSocial());
    	rutFacturaTextField.setText(this.empresa.getRutRepresentante());
    	razonSocialFacturaTextField.setText(this.empresa.getRazonSocialRepresentante());
