 ...
 */
public class FacturaView extends AbstractView {
	private Widget widget;

	public FacturaView() {
	}

	public FacturaView(Widget widget) {
		setWidget(widget);
	}
	...
	protected JComponent createControl() {
		...
		if (widgetCommands != null) {
			JComponent widgetButtonBar = CommandGroup.createCommandGroup(
					widgetCommands).createButtonBar(
					ColumnSpec.decode("fill:pref:nogrow"),
					RowSpec.decode("fill:default:nogrow"), null);
